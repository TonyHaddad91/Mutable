...
-(instancetype)init {
    if (self = [super init]) {
        NSString *configString = [[NSString alloc] initWithContentsOfFile:[[NSBundle mainBundle] pathForResource:@"config" ofType:@"json"] encoding:NSUTF8StringEncoding error:nil];
